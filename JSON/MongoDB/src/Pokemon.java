...
public class Pokemon {
    ...
    public List<Evolucion> getPrev_evolution() {
        return prev_evolution;
    }


    public void setPrev_evolution(List<Evolucion> prev_evolution) {
        this.prev_evolution = prev_evolution;
    }


    public List<Evolucion> getNext_evolution() {
        return next_evolution;
    }


    public void setNext_evolution(List<Evolucion> next_evolution) {
